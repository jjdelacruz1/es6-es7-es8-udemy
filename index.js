let harry = `Mr. and Mrs. Dursley, of number four, Privet Drive, were proud to say that they were perfectly normal, thank you very much. They were the last people you'd expect`
let lotr = `When Mr. Bilbo Baggins of Bag End announced that he would shortly be celebrating his eleventy-first birthday with a party of special magnificence, there was much`
...
function buildHTML2(tags, lines) {
  return function(element){
    ...
    // THIS IS NOT JSX/these are not components. You can't drop an array into the DOM
